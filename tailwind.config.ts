  ...
  theme: {
    ...
    extend: {
      colors: {
        // Brand Colors
        brand: {
          "dark-blue": "#1E3D59", // Header/Footer Background, CTA buttons
          "light-blue": "#D4E2EC", // Accent, Section Backgrounds
          gold: "#D6A767", // Icons, Leaves, Highlights
          white: "#FFFFFF", // Background, card elements
